...
func (e *AdminBaseController) GetCurrentUser() (int64, string, error) {
	...
	// 发送 http 请求
	if err = request.Request.WebPOSTSendPayload("ServiceURL_User_ValidToken", bytes.NewBufferString(params.Encode()), &responseJSON, true, false, false, false); err != nil {
...
func (e *AdminBaseController) HasPermissions(userID, powerID int64) bool {
	...
	// 发送 http 请求
	if err = request.Request.WebPOSTSendPayload("ServiceURL_Role_GetRolesForUser", bytes.NewBufferString(params.Encode()), &responseRolsJSON, true, false, false, false); err != nil {
	...
	for _, v := range responseRolsJSON {
		...
		if err = request.Request.WebGETSendPayload("ServiceURL_Role_GetPermissionsForRole", params, &responsePermissionsJSON, true, false, false, false); err != nil {
