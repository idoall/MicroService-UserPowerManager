...
import (
	...
	comumnModels "github.com/idoall/MicroService-UserPowerManager/web/controllers/admin/columns/models"
	"github.com/idoall/MicroService-UserPowerManager/web/controllers/admin/usersgroup/models"
)
...
func (e *UsersGroupController) GetListJSON() {
	...
	// 发送 http 请求
	err = request.Request.WebGETSendPayload("ServiceURL_UsersGroup_GetList", params, &jsonList, true, false, false, false)
	if err != nil {
		jsonList.ErrMessage = err.Error()
		e.Data["json"] = jsonList
		e.ServeJSON()
...
func (e *UsersGroupController) AddSave() {
	...
	// 发送 http 请求
	if err = request.Request.WebPOSTSendPayload("ServiceURL_UsersGroup_Add", bytes.NewBufferString(params.Encode()), &responseJSON, true, false, false, false); err != nil {
		result.Code = -1
...
func (e *UsersGroupController) Update() {
	...
	// 发送 http 请求
	if err = request.Request.WebGETSendPayload("ServiceURL_UsersGroup_Get", params, &responseJSON, true, false, false, false); err != nil {
		result.Code = -1
		result.Msg = err.Error()
		e.Data["json"] = result
		e.ServeJSON()
...
func (e *UsersGroupController) UpdateSave() {
	...
	// 发送 http 请求
	if err = request.Request.WebPOSTSendPayload("ServiceURL_UsersGroup_Update", bytes.NewBufferString(params.Encode()), &responseJSON, true, false, false, false); err != nil {
		result.Code = -1
		result.Msg = err.Error()
		e.Data["json"] = result
		e.ServeJSON()
...
func (e *UsersGroupController) Delete() {
	...
	// 发送 http 请求
	if err = request.Request.WebPOSTSendPayload("ServiceURL_UsersGroup_BatchDelete", bytes.NewBufferString(params.Encode()), &responseJSON, true, false, false, false); err != nil {
		result.Code = -1
		result.Msg = err.Error()
		e.Data["json"] = result
		e.ServeJSON()
...
func (e *UsersGroupController) GetColumnPowerTreeViewJSON() {
	var err error
	var list []*comumnModels.TreeView
	var result comumnModels.Result
	...
	// 发送 http 请求
	if err = request.Request.WebGETSendPayload("ServiceURL_Role_GetPermissionsForUser", params, &responseJSON, true, false, false, false); err != nil {
		result.Code = -1
		result.Msg = err.Error()
		e.Data["json"] = result
		e.ServeJSON()
	...
	for _, v := range list {
		for _, cv := range columnPowerList {
			...
			if v.ID == cid {
				v.State = &comumnModels.TreeViewState{Checked: true, Expanded: true}
			}
			if v.Nodes != nil {
...
func (e *UsersGroupController) getRecursiveColumnPowerTreeView(columnPowerList []map[string][]string, list []*comumnModels.TreeView) {
...
func (e *UsersGroupController) ColumnPowerSave() {
	...
	// 发送 http 请求
	if err = request.Request.WebPOSTSendPayload("ServiceURL_Role_RemoveFilteredPolicy", bytes.NewBufferString(params.Encode()), nil, true, false, false, false); err != nil {
		result.Code = -1
		result.Msg = err.Error()
		e.Data["json"] = result
		e.ServeJSON()
	...
	for _, v := range idArray {
		...
		// 发送 http 请求
		if err = request.Request.WebPOSTSendPayload("ServiceURL_Role_AddPolicy", bytes.NewBufferString(params.Encode()), nil, true, false, false, false); err != nil {
			result.Code = -1
			result.Msg = err.Error()
			e.Data["json"] = result
			e.ServeJSON()
