...
func (e *Users) Add(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_User_Add_End")
	if span != nil {
		defer span.Finish()
...
func (e *Users) GetList(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_User_GetList_End")
	if span != nil {
		defer span.Finish()
...
func (e *Users) GetUser(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_User_GetUser_End")
	if span != nil {
		defer span.Finish()
		span.SetTag("ID", ID)
	}
...
func (e *Users) Update(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_User_Update_End")
	if span != nil {
		defer span.Finish()
		span.SetTag("ID", ID)
	}
...
func (e *Users) BatchDelete(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_User_BatchDelete_End")
	if span != nil {
		defer span.Finish()
...
func (e *Users) UserLogin(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	if err != nil {
		if utils.RunMode == "dev" {
			inner.Mlogger.Infof("Received API [Users][UserLogin] e.Client.Get Error:%+v", err)
		}
		return errors.InternalServerError(namespaceID, err.Error())
	}
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_User_UserLogin_End")
	if span != nil {
		defer span.Finish()
...
func (e *Users) ValidToken(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_User_ValidToken_End")
	if span != nil {
		defer span.Finish()
		span.SetTag("Token", tokenString)
	}
