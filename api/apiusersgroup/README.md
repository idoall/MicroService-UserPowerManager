...
$ curl -XPOST -H 'Content-Type: application/x-www-form-urlencoded' \
      -d 'Name=Admin Group&Sorts=123password' \
      --url http://localhost:8080/mshk/api/v1/ApiUsersGroup/add
{"id":"go.micro.api.mshk.api.v1","code":500,"detail":"Sorts Int64FromString Error:unable to parse, value not string: *go_api.Pair","status":"Internal Server Error"}%
