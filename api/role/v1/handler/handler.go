...
// GetPermissionsForRole 根据用户获取权限
...
func (e *Role) GetPermissionsForRole(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_Role_GetPermissionsForRole_End")
	if span != nil {
		defer span.Finish()
	}
...
func (e *Role) GetPermissionsForUser(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_Role_GetPermissionsForUser_End")
	if span != nil {
		defer span.Finish()
	}
...
func (e *Role) DeletePermissionsForUser(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_Role_DeletePermissionsForUser_End")
	if span != nil {
		defer span.Finish()
	}
...
func (e *Role) RemoveFilteredPolicy(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_Role_RemoveFilteredPolicy_End")
	if span != nil {
		defer span.Finish()
	}
...
func (e *Role) AddPolicy(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_Role_AddPolicy_End")
	if span != nil {
		defer span.Finish()
	}
...
func (e *Role) AddGroupingPolicy(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_Role_AddGroupingPolicy_End")
	if span != nil {
		defer span.Finish()
	}
...
func (e *Role) GetRolesForUser(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_Role_GetRolesForUser_End")
	if span != nil {
		defer span.Finish()
	}
...
func (e *Role) DeleteRolesForUser(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	// 写入一个 jaeger span
	_, span = jaeger.StartSpan(ctx, "Api_Role_DeleteRolesForUser_End")
	if span != nil {
		defer span.Finish()
	}
