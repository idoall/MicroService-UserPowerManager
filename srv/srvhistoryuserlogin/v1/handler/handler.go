...
import (
	...
	proto "github.com/idoall/MicroService-UserPowerManager/srv/srvhistoryuserlogin/v1/proto"
...
// 添加一条记录
func (e *SrvHistoryUserLogin) Add(ctx context.Context, req *proto.AddRequest, rep *proto.AddResponse) error {
	// 写入一个 jaeger span
