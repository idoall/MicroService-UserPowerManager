...
func (c *srvRoleService) DeleteRolesForUser(ctx context.Context, in *ForUserRequest, opts ...client.CallOption) (*Empty, error) {
	req := c.c.NewRequest(c.name, "SrvRole.DeleteRolesForUser", in)
	out := new(Empty)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *srvRoleService) AddGroupingPolicy(ctx context.Context, in *AddGroupingPolicyRequest, opts ...client.CallOption) (*Empty, error) {
	req := c.c.NewRequest(c.name, "SrvRole.AddGroupingPolicy", in)
	out := new(Empty)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func RegisterSrvRoleHandler(s server.Server, hdlr SrvRoleHandler, opts ...server.HandlerOption) error {
	type srvRole interface {
		...
		DeleteRolesForUser(ctx context.Context, in *ForUserRequest, out *Empty) error
		AddGroupingPolicy(ctx context.Context, in *AddGroupingPolicyRequest, out *Empty) error
	}
	type SrvRole struct {
		srvRole
	}
...
func (h *srvRoleHandler) DeleteRolesForUser(ctx context.Context, in *ForUserRequest, out *Empty) error {
	return h.SrvRoleHandler.DeleteRolesForUser(ctx, in, out)
}

func (h *srvRoleHandler) AddGroupingPolicy(ctx context.Context, in *AddGroupingPolicyRequest, out *Empty) error {
	return h.SrvRoleHandler.AddGroupingPolicy(ctx, in, out)
}
